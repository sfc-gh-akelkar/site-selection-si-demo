/*******************************************************************************
 * MEDPACE SPONSOR INSIGHTS AGENT - STEP 3: SEMANTIC VIEWS
 * 
...
CREATE OR REPLACE SEMANTIC VIEW ENROLLMENT_SEMANTIC_VIEW
    ...
    TABLES (
        enrollment AS MEDPACE_DEMO.CLINICAL_OPERATIONS.TRIAL_ENROLLMENT_METRICS 
...
CREATE OR REPLACE SEMANTIC VIEW SITE_PERFORMANCE_SEMANTIC_VIEW
    ...
    TABLES (
        site_perf AS MEDPACE_DEMO.CLINICAL_OPERATIONS.SITE_PERFORMANCE_DASHBOARD 
